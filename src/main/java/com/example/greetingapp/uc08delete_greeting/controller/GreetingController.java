package com.example.greetingapp.uc08delete_greeting.controller;

import com.example.greetingapp.uc08delete_greeting.model.Greeting;
import com.example.greetingapp.uc08delete_greeting.repository.GreetingRepository;
...
public class GreetingController {
    ...
    public String deleteGreeting(@PathVariable Long id) {
        boolean deleted = greetingRepository.deleteGreeting(id);
